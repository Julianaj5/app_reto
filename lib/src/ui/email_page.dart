import 'package:app_reto/src/ui/register_page.dart';
import 'package:app_reto/src/ui/signin_page.dart';
  ...
  void signInWithEmail() async {
    ...
    try {
      user = (await _auth.signInWithEmailAndPassword(
          email: _emailController.text, password: _passwordController.text)) as User;
    } catch (e) {
      print(e.toString());
    } finally {
      if (user != null) {
